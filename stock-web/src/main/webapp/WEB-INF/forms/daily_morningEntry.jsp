...
function submitThisForm() {
	...
	<form:form method="POST" modelAttribute="morningentry"
		...
		action="${pageContext.request.contextPath}/vaccinator/dailymorningentry.htm">
		<center>
			<table cellspacing=10>
				<tr>
					<td><form:label path="openingTemprature">Enter the opening temprature</form:label></td>
					<td><form:input path="openingTemprature" /></td>
					<td><form:errors path = "openingTemprature" cssStyle="color: #ff0000;" /></td>
				</tr>
			<tr>
					<td>ILR Status *</td>
					<td><form:select path="ilrStatus">
							<form:option value="" label="Please Select" />
							<form:options items="${array}" />
						</form:select></td> 
						<td><form:errors path="ilrStatus" cssStyle="color: #ff0000" /></td>
