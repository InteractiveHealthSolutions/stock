...
//	@ResponseBody
//	public ModelAndView getVaccinatorBalanceStats(
//			/* @PathVariable int consumer, */HttpServletRequest request, HttpServletResponse response,
...
//	}
//
//	// @RequestMapping(value = "/locationBalance/{consumer}" , method =
//	// RequestMethod.GET)
//	// @ResponseBody
//	// public ModelAndView viewLocationStats(@PathVariable int
//	// consumer,ModelAndView modelAndView)
//	// {
//	// vacDataAccess = new VaccinatorDataAccessService();
//	// List<Inventory> vacMonStats = (List<Inventory>)
//	// vacDataAccess.viewLocationBalance(consumer);
//	//
//	// String monthString = new
//	// DateFormatSymbols().getMonths()[vacMonStats.get(0).getmonth()-1];
//	// modelAndView.addObject("year", vacMonStats.get(0).getyear());
//	// modelAndView.addObject("month", monthString);
//	// modelAndView.addObject("list", vacMonStats);
...
//	// public ModelAndView viewDailyStats(/*@PathVariable int customer ,*/
//	// ModelAndView modelAndView) throws ParseException
//	// {
//	// vacDataAccess = new VaccinatorDataAccessService();
//	// List<DailyStats> dailyStats = (List<DailyStats>)
//	// vacDataAccess.viewDailyStats(1);
//	// String date = dailyStats.get(0).getdateCreated().toString().substring(0,
//	// 10);
